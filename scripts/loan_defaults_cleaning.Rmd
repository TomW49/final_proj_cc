...
### Mean/median number of loans per state + Ration of defaulter per state
```{r}
...
### Barchart - Total LendingClub Loans Per State
```{r}
...
### Barchart - Total Defaulted LendingClub Loans Per State
```{r}
...
### Barchart - Ratio of Defaulted LendingClub Loans Per State(highlighting top 5 states above avg loan count)
```{r}
...
### Barchart - Volume of LendingClub Loan Catagories
```{r}
...
### Linegraph: †ypes of p2p loans over time
```{r}
#-------------------------------
