...
```{r}
# selecting categorical vars + on boarding vars
...
loans_trim %>% 
  select(c(loan_amnt, term, int_rate, installment, sub_grade, emp_length, home_ownership, verification_status, annual_inc, issue_d, purpose, zip_code, delinq_2yrs, fico_range_low, mths_since_last_delinq))
```
