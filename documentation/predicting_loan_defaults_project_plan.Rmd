...
There was no immediate bias observed as the data had customer profiles representing all American states from varying incomes, home ownership and employments. What I did discover though was a disproportionate volume of loans per state - however this turned out to be proportional to the population of te state.

# Ethics

#### Ethical issues in data sourcing and extraction, PDA 2.7

The data set it open source on Kaggle.com however there appears to be a varying amount of data set, each with their own nuances. I was provided the data by CodeClan and as such extraction did not present any concerns. 
...
The business requirement itself is asking to identify customers to possibly prevent getting a loan due to likelihood of defaulting on that loan. By proxy this is excluding individuals from their services. However, by taking this course of action LendingClub is not only protecting their business in terms of profit loss, but they are also protecting the consumer by preventing them from acquiring debt they are most likely unable to pay back in full. If a customer is in desperate need for a loan, they can approach the many other banks and lenders who would have lower tolerances for risk.
...
Based on the relationships between the customers attributes and if they had defaulted on their loan or not, I looked created a profile of a customer who was more and least likely to default on their loan in the future. This was the intent of the logistical regression model however since that model failed I used basic relationships within the data set instead.
